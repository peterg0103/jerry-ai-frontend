...
const Support = ({ targetLang, setTargetLang }) => {
  ...
  // =========================
  // No useState hooks needed for this component
  ...
  const EN = {
    ...
    overviewText: "Jerry's AI Support Center is dedicated to helping all registered users and partners receive fast, accurate, and secure assistance for technical, subscription, and account-related issues. This document outlines the available channels, expected response times, and the scope of support provided.",
