...
const GeneralServices = ({ targetLang, setTargetLang }) => {
  ...
  // Inline styles (simplified - keep your existing styles)
  const styles = {
          ...
          <div className="gs-card">
            ...
            <div className="gs-service-grid">
              {communicationServices.map((service, index) => (
                <div key={index} className={`gs-service-card ${hoveredService === `comm-${index}` ? 'gs-service-card-hover' : ''}`} onMouseEnter={() => setHoveredService(`comm-${index}`)} onMouseLeave={() => setHoveredService(null)}>
            ...
            <div className="gs-service-grid">
              {digitalServices.map((service, index) => (
                <div key={index} className={`gs-service-card ${hoveredService === `digital-${index}` ? 'gs-service-card-hover' : ''}`} onMouseEnter={() => setHoveredService(`digital-${index}`)} onMouseLeave={() => setHoveredService(null)}>
                  <h4 className="gs-service-title">{service.title}</h4>
                  <p className="gs-service-desc">{service.desc}</p>
                  <div className="gs-service-help">{service.help}</div>
                </div>
            ...
            <div className="gs-service-grid">
              {dataServices.map((service, index) => (
                <div key={index} className={`gs-service-card ${hoveredService === `data-${index}` ? 'gs-service-card-hover' : ''}`} onMouseEnter={() => setHoveredService(`data-${index}`)} onMouseLeave={() => setHoveredService(null)}>
                  <h4 className="gs-service-title">{service.title}</h4>
                  <p className="gs-service-desc">{service.desc}</p>
                  <div className="gs-service-help">{service.help}</div>
                </div>
            ...
            <div className="gs-service-grid">
              {educationServices.map((service, index) => (
                <div key={index} className={`gs-service-card ${hoveredService === `edu-${index}` ? 'gs-service-card-hover' : ''}`} onMouseEnter={() => setHoveredService(`edu-${index}`)} onMouseLeave={() => setHoveredService(null)}>
                  <h4 className="gs-service-title">{service.title}</h4>
                  <p className="gs-service-desc">{service.desc}</p>
                  <div className="gs-service-help">{service.help}</div>
                </div>
            ...
            <div className="gs-cta-section">
              ...
              <Link to="/pricing" className="gs-cta-button">{t("ctaButton")}</Link>
            </div>
