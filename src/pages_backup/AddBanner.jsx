...
import "./AddBanner.css"; // Import the CSS file
      ...
      <div className="page">
        <div className="banner-container">
          <div className="banner-card">
            ...
            <div className="banner-image-section">
              <img
                src={ASSET("/images/general/icons/jerry-ai-banr.png")}
                alt="AI Banner Advertising Solutions"
            ...
            <div className="banner-content">
              ...
              <div className="banner-section">
                ...
                <div className="banner-benefits-grid">
                  {benefits.map((benefit, index) => (
                    <div
                      key={index}
                      className={`banner-benefit-card ${hoveredBenefit === index ? 'banner-benefit-card-hover' : ''}`}
                      onMouseEnter={() => setHoveredBenefit(index)}
                      onMouseLeave={() => setHoveredBenefit(null)}
                    >
                      <h3 className="banner-benefit-title">
                        {benefit.title}
                      </h3>
              ...
              <div className="banner-section">
                ...
                <div className="banner-performance-stats">
                  {stats.map((stat, index) => (
                    <div
                      key={index}
                      className={`banner-stat-card ${hoveredStat === index ? 'banner-stat-card-hover' : ''}`}
              ...
              <div className="banner-section">
                ...
                <ul className="banner-list">
                  {packageList.map((item, index) => (
                    <li key={index} className="banner-list-item">{item}</li>
                  ))}
                </ul>
              </div>
              ...
              <div className="banner-cta">
                ...
                <Link to="/subscribe" className="banner-cta-button">
                  {t("ctaButton")}
                </Link>
              </div>
        ...
        <footer>
          <div className="banner-footer-inner">
            <div>
              <div className="banner-footer-title">{t("footerCompany")}</div>
              <div className="banner-footer-links">
                <Link to="/about" className="banner-footer-link">{t("aboutUs")}</Link>
                <Link to="/support" className="banner-footer-link">{t("support")}</Link>
                <Link to="/contact" className="banner-footer-link">{t("contactUs")}</Link>
                <Link to="/GeneralServices" className="banner-footer-link">{t("generalServices")}</Link>
                <Link to="/pricing" className="banner-footer-link">{t("pricing")}</Link>
              </div>
            </div>

            <div>
              <div className="banner-footer-title">{t("footerServices")}</div>
              <div className="banner-footer-links">
                <Link to="/subscribe" className="banner-footer-link">{t("subscriptionPlan")}</Link>
                <Link to="/ai-pro-chat-info" className="banner-footer-link">{t("professionalAIChat")}</Link>
                <Link to="/add-banner" className="banner-footer-link">{t("addBannerFooter")}</Link>
                <Link to="/education" className="banner-footer-link">{t("educationFooter")}</Link>
                <Link to="/web-development" className="banner-footer-link">{t("webDevelopmentFooter")}</Link>
                <Link to="/app-development" className="banner-footer-link">{t("appDevelopmentFooter")}</Link>
                <Link to="/digital-marketing" className="banner-footer-link">{t("digitalMarketingFooter")}</Link>
                <Link to="/voice-translator" className="banner-footer-link">{t("voiceTranslatorFooter")}</Link>
                <Link to="/analyse-data" className="banner-footer-link">{t("analyseDataFooter")}</Link>
                <Link to="/cybersecurity" className="banner-footer-link">{t("enhanceCyberFooter")}</Link>
                <Link to="/find-my-phone" className="banner-footer-link">{t("findMyPhoneFooter")}</Link>
              </div>
            </div>

            <div>
              <div className="banner-footer-title">{t("footerLegality")}</div>
              <div className="banner-footer-links">
                <Link to="/terms" className="banner-footer-link">{t("terms")}</Link>
                <Link to="/privacy" className="banner-footer-link">{t("privacy")}</Link>
                <Link to="/pdpa" className="banner-footer-link">{t("pdpa")}</Link>
                <Link to="/services" className="banner-footer-link">{t("servicesPolicy")}</Link>
              </div>
            </div>

            <div>
              <div className="banner-footer-title">{t("footerConnection")}</div>
              <div className="banner-footer-links">
                <a href="#" className="banner-footer-link" onClick={(e) => { e.preventDefault(); alert("Link later"); }}>
                  {t("facebook")}
                </a>
                <a href="#" className="banner-footer-link" onClick={(e) => { e.preventDefault(); alert("Link later"); }}>
                  {t("linkedin")}
