...
console.log("videoTitle exists:", EN.videoTitle ? "YES" : "NO");
console.log("socialTitle exists:", EN.socialTitle ? "YES" : "NO");
console.log("backupTitle exists:", EN.backupTitle ? "YES" : "NO");
console.log("corporateTitle exists:", EN.corporateTitle ? "YES" : "NO");
  ...
  const styles = {
    ...
    serviceCard: {
      background: "white",
      border: "1px solid rgba(16, 167, 255, 0.2)",
      borderRadius: "10px",
      padding: "20px",
    ...
    serviceCardHover: {
      ...
      boxShadow: "0 10px 25px rgba(16, 167, 255, 0.15)",
    },
    serviceTitle: {
      fontSize: "20px",
      color: "#10a7ff",
    ...
    serviceHelp: {
      ...
      color: "#64748b",
      padding: "12px",
      background: "rgba(16, 167, 255, 0.05)",
      borderRadius: "6px",
      borderLeft: "3px solid #10a7ff",
      marginTop: "auto",
    },
    helpPoints: {
      display: "grid",
 ...
 console.log({
  communicationServices: communicationServices.length,
  digitalServices: digitalServices?.length,
  dataServices: dataServices?.length,
  educationServices: educationServices?.length,
});
      ...
      <div className="page">
        <div style={styles.container}>
          <div style={styles.card}>
            ...
            {/* Communication Services - NOW 4 CARDS (2x2 grid, NO EMPTY SPACE) */}
            ...
            <div style={styles.serviceGrid}>
              {communicationServices.map((service, index) => (
                <div
                  ...
                  style={{
                    ...styles.serviceCard,
                    ...(hoveredService === `comm-${index}` ? styles.serviceCardHover : {}),
                  }}
            ...
            {/* Digital Services - NOW 6 CARDS (3 rows of 2, NO EMPTY SPACE) */}
            ...
            <div style={styles.serviceGrid}>
              {digitalServices.map((service, index) => (
                <div
                  ...
                  style={{
                    ...styles.serviceCard,
                    ...(hoveredService === `digital-${index}` ? styles.serviceCardHover : {}),
                  }}
            ...
            {/* Data Services - NOW 4 CARDS (2x2 grid, NO EMPTY SPACE) */}
            ...
            <div style={styles.serviceGrid}>
              {dataServices.map((service, index) => (
                <div
                  ...
                  style={{
                    ...styles.serviceCard,
                    ...(hoveredService === `data-${index}` ? styles.serviceCardHover : {}),
                  }}
            ...
            {/* Education Services - NOW 2 CARDS (1 row of 2, NO EMPTY SPACE) */}
            ...
            <div style={styles.serviceGrid}>
              {educationServices.map((service, index) => (
                <div
                  ...
                  style={{
                    ...styles.serviceCard,
                    ...(hoveredService === `edu-${index}` ? styles.serviceCardHover : {}),
                  }}
            ...
            {/* Problem Matrix - NOW 14 CARDS (7 rows of 2, NO EMPTY SPACE) */}
            <div style={styles.section}>
            ...
            <div style={styles.ctaSection}>
              ...
              <Link to="/pricing" style={styles.ctaButton}>
                {t("ctaButton")}
              </Link>
            </div>
