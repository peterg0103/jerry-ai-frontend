...
console.log('🔍 DigitalMarketing received targetLang:', targetLang); 
  ...
  const EN = {
    ...
    enhanced1_part1: "In today's increasingly digital world, having a strong online presence is no longer optional—it's fundamental to business survival and growth. Digital marketing provides the unique advantage of reaching your exact target audience with precision and efficiency that traditional marketing methods simply cannot match.",
    enhanced1_part2: "Through sophisticated data analytics and AI-driven insights, we can identify exactly who your ideal customers are, where they spend their time online, and what messaging resonates most effectively with them. This level of targeting ensures that every marketing dollar is spent efficiently, maximizing your return on investment.",
    enhanced2_part1: "Beyond mere visibility, effective digital marketing builds meaningful connections with your audience. Through compelling content, engaging social media interactions, and personalized email campaigns, we help transform casual browsers into loyal brand advocates.",
    enhanced2_part2: "The digital landscape is constantly evolving, with new platforms, algorithms, and consumer behaviors emerging regularly. Our adaptive approach ensures your marketing strategy remains agile and responsive to these changes, keeping you ahead of competitors.",
    enhanced2_part3: "Whether you're looking to increase brand awareness, generate qualified leads, or boost online sales, our comprehensive digital marketing services provide the strategic framework and tactical execution needed to achieve your specific business objectives in the digital age.",
    metric1Value: "40-70%",
  ...
  // =========================
  // 3️⃣ TRANSLATION HOOK (ONLY ONCE)
  // =========================
          ...
          <div className="dm-card">
            ...
            <div className="dm-content">
              ...
              <div className="dm-section">
                ...
                <p className="dm-content-paragraph">{t("enhanced1_part1")}</p>
                <p className="dm-content-paragraph">{t("enhanced1_part2")}</p>
                <p className="dm-content-paragraph">{t("enhanced2_part1")}</p>
                <p className="dm-content-paragraph">{t("enhanced2_part2")}</p>
                <p className="dm-content-paragraph">{t("enhanced2_part3")}</p>
              </div>
